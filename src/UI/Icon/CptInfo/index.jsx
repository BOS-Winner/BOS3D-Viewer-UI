...
const mapDispatchToProps = (dispatch) => ({
  ...
  setFamilyInfoHidden: (payload) => {
    dispatch(setFamilyInfoVisible(payload));
  },
});
...
export default connect(mapStateToProps, mapDispatchToProps)(CptInfo);
