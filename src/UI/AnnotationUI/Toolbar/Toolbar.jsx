...
class Toolbar extends React.Component {
  ...
  render() {
    ...
    // 填充色
    let _fillColor = (this.props.fillColor === "none" && this.props.isTextAttri === true) ? DEF_COLOR : this.props.fillColor;
      ...
      <div className={style.container}>
        <div className={style.btnGroup}>
          <div className={style.itemGroup}>
            {
              FIRST_LINES.map((item, idx) => <div className={style.item} key={idx} >
          ...
          <div className={style.itemGroup}>
            {SECOND_LINES.map((item, idx) => <div className={style.item} key={idx} >
              <ToolbarItem title={item.title} tag={item.tag} selected={this.props.selectedButton === item.tag} icon={item.icon} onClick={this.buttonAction} />
            </div>)}
          </div>
          {
